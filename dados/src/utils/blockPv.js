...
export const menuCommandsMap = {
    ...
    menudono: {
        menuName: 'Dono',
        commands: ['cmd', 'exec', 'bc', 'broadcast', 'sair', 'entrar', 'nomebot', 'fotobot', 'bloquear', 'desbloquear', 'userblock', 'block', 'unblock', 'listblocks', 'modoligado', 'mododesligado', 'verificar', 'criarpv', 'deletepv', 'backup', 'setgroq', 'vergroq', 'settipoia', 'settipochat', 'regrasgp', 'rconfig', 'bconfig', 'config', 'addpalavra', 'delpalavra', 'listapc', 'antipalavras', 'addsticker', 'delsticker', 'listasticker', 'blackpalavra', 'bcgc', 'msgauto', 'addmsg', 'delmsg', 'listmsg', 'statusbot', 'att', 'update', 'restart', 'desligar', 'ligar', 'ping']
    },
    menumemb: {
        menuName: 'Membros',
