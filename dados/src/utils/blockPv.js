...
export const menuCommandsMap = {
    ...
    menu18: {
        menuName: 'Plaquinhas',
        commands: ['plaq1', 'plaq2', 'plaq3', 'plaq4', 'plaq5', 'plaq6', 'plaq7', 'plaq8', 'plaq9', 'plaq10', 'vab18']
    },
    alteradores: {
